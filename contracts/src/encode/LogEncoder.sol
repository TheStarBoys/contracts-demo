...
library LogEncoder {    
    ...
    function topic(bytes32 b) internal pure returns (bytes32) {
        return bytes32(b);
    }
    ...
    function topic(uint256 v) internal pure returns (bytes32) {
        return bytes32(uint256(v));
    }



    function topic(int256 v) internal pure returns (bytes32) {
        return bytes32(uint256(int256(v)));
    }


    function data(bytes calldata v) internal pure returns (bytes memory) {
        return abi.encode(v);
    }

    function data(string calldata v) internal pure returns (bytes memory) {
        return abi.encode(v);
    }

    function data(bool v) internal pure returns (bytes memory) {
        return abi.encode(v);
    }

    function data(address v) internal pure returns (bytes memory) {
        return abi.encode(v);
    }

    function data(bytes32 v) internal pure returns (bytes memory) {
        return abi.encode(v);
    }

    function data(uint256 v) internal pure returns (bytes memory) {
        return abi.encode(v);
    }

    function data(int256 v) internal pure returns (bytes memory) {
        return abi.encode(v);
    }
